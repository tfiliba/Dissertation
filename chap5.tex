...
\begin{figure}[ht!]
  ...
  \caption{Full-Crossbar Interconnect}
...
Discussion of benchmarks (show size vs resources) FFT, FIR,

\begin{figure}[ht!]
  \centering
    \includegraphics[width=0.49\textwidth]{Images/C6/pfb_bench.png}
     \includegraphics[width=0.49\textwidth]{Images/C6/pfb_gpu_bench.png}
  \caption{PFB FIR benchmark data on the Virtex V SX95T and GTX 580}
...
\begin{figure}[ht!]
  ...
  \caption{FFT benchmark data on the Virtex V SX95T and GTX 580}
...
\begin{figure}[ht!]
  \centering
     \includegraphics[width=\textwidth]{Images/C5/mapped_dataflow.png}
  \caption{TODO}
...
%TODO: Dan - discuss what worked and what didn't
%TODO: Discuss different implementations open source vs gurobi, python packages
